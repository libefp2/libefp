    ...
    for pth in fragpath.split(os.pathsep):
        if pth == 'LIBRARY':
            for lst in [paths, library_paths]:
                for spth in '/depot/lslipche/data/skp/branch/pylibefp/libefp/install/share/libefp/fraglib;/depot/lslipche/data/skp/branch/pylibefp/libefp/install/share/libefp/fraglib/databases'.split(';'):
                    lst.append(spth)
                ...
                for spth in ''.split(';'):
                    lst.append(str((Path('/depot/lslipche/data/skp/branch/pylibefp/libefp/python') / '..' / spth).resolve()))
        else:
