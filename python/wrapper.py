...
def add_potential(efpobj, potential, fragpath='LIBRARY', duplicates_ok=False):
    ...
    for pth in fragpath.split(os.pathsep):
		...
		#lst.append('/scratch/gilbreth/paulsk/backup/libefp/installed/share/libefp/fraglib')
                #lst.append('/scratch/gilbreth/paulsk/backup/libefp/installed/share/libefp/fraglib/databases')
                #lst.append('/opt/anaconda1anaconda2anaconda3/Library/share/libefp/fraglib')
                #lst.append('/opt/anaconda1anaconda2anaconda3/Library/share/libefp/fraglib/databases')
...
def set_opts(efpobj, dopts, label='libefp', append='libefp'):
    ...
    if append == 'libefp':
        ...
        opts.terms |= core.efp_term.EFP_TERM_QQ # SKP
        opts.terms |= core.efp_term.EFP_TERM_LJ # SKP
        ...
        opts.terms |= core.efp_term.EFP_TERM_AI_QQ # SKP
    #elif append == 'qchem':
